// Upgrade NOTE: upgraded instancing buffer 'HiddenTITANFALLTerrainThreeBlends' to new syntax.

// Made with Amplify Shader Editor v1.9.1.5
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "Hidden/TITANFALL/Terrain (Three Blends)"
{
	Properties
	{
		...
		[Header(________________________________________________________________________________________________)][Header(Terrain Blending (Blue))]_ColorBlue("Color", Color) = (1,1,1,1)
		[SingleLineTexture]_ColBlue("_Col", 2D) = "white" {}
		[SingleLineTexture]_NmlBlue("_Nml", 2D) = "bump" {}
		_NormalStrengthB("Normal Strength", Float) = 1
		[SingleLineTexture]_SpcBlue("_Spc", 2D) = "black" {}
		_SmoothnessBlue("Smoothness", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		uniform sampler2D _NmlBlue;
		uniform sampler2D _MainTex;
		uniform sampler2D _DetailAlbedoMap;
		uniform sampler2D _ColGreen;
		uniform sampler2D _ColBlue;
		uniform sampler2D _SpecGlossMap;
		uniform sampler2D _CamoSpc;
		uniform sampler2D _SpcGreen;
		uniform sampler2D _SpcBlue;
		uniform sampler2D _GlossMap;

		UNITY_INSTANCING_BUFFER_START(HiddenTITANFALLTerrainThreeBlends)
			UNITY_DEFINE_INSTANCED_PROP(float4, _Tiling)
#define _Tiling_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color)
#define _Color_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(float4, _ColorRed)
#define _ColorRed_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(float4, _ColorGreen)
#define _ColorGreen_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(float4, _ColorBlue)
#define _ColorBlue_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(int, _DepthOffset)
#define _DepthOffset_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(int, _CullMode)
#define _CullMode_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(float, _NormalScale)
#define _NormalScale_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(float, _DetailBumpStrength)
#define _DetailBumpStrength_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(float, _NormalStrengthG)
#define _NormalStrengthG_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(float, _NormalStrengthB)
#define _NormalStrengthB_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(float, _Glossiness)
#define _Glossiness_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(float, _DetailSmoothness)
#define _DetailSmoothness_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(float, _SmoothnessGreen)
#define _SmoothnessGreen_arr HiddenTITANFALLTerrainThreeBlends
			UNITY_DEFINE_INSTANCED_PROP(float, _SmoothnessBlue)
#define _SmoothnessBlue_arr HiddenTITANFALLTerrainThreeBlends
		UNITY_INSTANCING_BUFFER_END(HiddenTITANFALLTerrainThreeBlends)
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float _NormalStrengthB_Instance = UNITY_ACCESS_INSTANCED_PROP(_NormalStrengthB_arr, _NormalStrengthB);
			float3 BlueBump171 = UnpackScaleNormal( tex2D( _NmlBlue, MainUV108 ), _NormalStrengthB_Instance );
			float3 Normal16 = BlendNormals( BlendNormals( BlendNormals( UnpackScaleNormal( tex2D( _BumpMap, MainUV108 ), _NormalScale_Instance ) , RedBump73 ) , GreenBump145 ) , BlueBump171 );
			o.Normal = Normal16;
			...
			float4 _ColorBlue_Instance = UNITY_ACCESS_INSTANCED_PROP(_ColorBlue_arr, _ColorBlue);
			float4 BlueCol172 = ( tex2D( _ColBlue, MainUV108 ) * _ColorBlue_Instance );
			float4 lerpResult178 = lerp( lerpResult156 , BlueCol172 , i.vertexColor.b);
			float4 Color48 = lerpResult178;
			...
			float4 BlueSpec173 = tex2D( _SpcBlue, MainUV108 );
			float4 lerpResult180 = lerp( lerpResult159 , BlueSpec173 , i.vertexColor.b);
			float4 Specular43 = lerpResult180;
			...
			float RedGloss77 = _DetailSmoothness_Instance;
			float4 temp_cast_2 = (RedGloss77).xxxx;
			float4 lerpResult93 = lerp( ( tex2D( _GlossMap, MainUV108 ) * _Glossiness_Instance ) , temp_cast_2 , i.vertexColor.r);
			float _SmoothnessGreen_Instance = UNITY_ACCESS_INSTANCED_PROP(_SmoothnessGreen_arr, _SmoothnessGreen);
			float GreenGloss143 = _SmoothnessGreen_Instance;
			float4 temp_cast_3 = (GreenGloss143).xxxx;
			float4 lerpResult157 = lerp( lerpResult93 , temp_cast_3 , i.vertexColor.g);
			float _SmoothnessBlue_Instance = UNITY_ACCESS_INSTANCED_PROP(_SmoothnessBlue_arr, _SmoothnessBlue);
			float BlueGloss174 = _SmoothnessBlue_Instance;
			float4 temp_cast_4 = (BlueGloss174).xxxx;
			float4 lerpResult179 = lerp( lerpResult157 , temp_cast_4 , i.vertexColor.b);
			float4 Gloss41 = lerpResult179;
...
Node;AmplifyShaderEditor.CommentaryNode;52;-2019.335,786.1785;Inherit;False;1323.35;432.6265;Normal;10;184;185;162;16;161;79;14;119;15;80;;0.5,0,0.4098039,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;50;-2017.627,-606.9152;Inherit;False;1322.748;365.7555;Color;11;48;182;178;156;155;58;6;135;54;64;2;;0.5,0.2627451,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;44;-2018.627,353.0847;Inherit;False;1326.025;394.1609;Specular;10;43;183;180;160;91;159;90;137;120;18;;0,0.09803939,0.5,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;40;-2017.627,-190.9152;Inherit;False;1330.268;495.5854;Gloss;12;41;181;179;158;157;93;136;121;19;94;20;21;;0.07058823,0.5,0,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;163;-1372.525,-1656.842;Inherit;False;887.1901;979.9791;BLUE TERRAIN;14;177;176;175;174;173;172;171;170;169;168;167;166;165;164;;0.09670687,0,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;172;-682.8723,-1600.513;Inherit;False;BlueCol;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.IntNode;38;-568.5518,466.5376;Inherit;False;InstancedProperty;_DepthOffset;DepthOffset;28;0;Create;True;0;0;0;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-312.5515,-13.46233;Float;False;True;-1;7;T2_TFShaderGUI;0;0;StandardSpecular;Hidden/TITANFALL/Terrain (Three Blends);False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;;0;False;;True;0;True;_DepthOffset;0;False;_DepthOffset;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;2;5;False;;10;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;_CullMode;-1;0;True;_AlphaClip;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.IntNode;37;-568.5518,370.5376;Inherit;False;InstancedProperty;_CullMode;CullMode;27;2;[Header];[Enum];Create;True;2;________________________________________________________________________________________________;Extras;3;Both;0;Back;1;Front;2;0;True;0;False;2;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;94;-1633.627,-14.91528;Inherit;False;77;RedGloss;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;158;-1448.661,-8.171767;Inherit;False;143;GreenGloss;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;178;-1059.098,-559.6456;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;179;-1069.098,-134.6456;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;180;-1048.098,416.3543;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;181;-1267.155,103.4356;Inherit;False;174;BlueGloss;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;182;-1259.968,-379.9489;Inherit;False;172;BlueCol;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;183;-1279.968,616.0513;Inherit;False;173;BlueSpec;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.BlendNormalsNode;185;-1081.545,975.6451;Inherit;False;0;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;184;-1306.545,1122.645;Inherit;False;171;BlueBump;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;143;-1607.964,-953.9259;Inherit;False;GreenGloss;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;165;-1324.809,-1372.662;Inherit;False;108;MainUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;166;-821.9744,-1600.643;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;170;-1324.809,-1292.662;Inherit;False;InstancedProperty;_NormalStrengthB;Normal Strength;25;0;Create;False;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;171;-844.8096,-1340.662;Inherit;False;BlueBump;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;173;-844.8096,-1148.662;Inherit;False;BlueSpec;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;174;-684.8093,-956.6622;Inherit;False;BlueGloss;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;164;-814.1093,-877.3625;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;77;-2523.919,-953.6118;Inherit;False;RedGloss;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;177;-1027.16,-1530.781;Inherit;False;InstancedProperty;_ColorBlue;Color;22;1;[Header];Create;False;2;________________________________________________________________________________________________;Terrain Blending (Blue);0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;176;-1132.81,-764.6625;Inherit;False;InstancedProperty;_SmoothnessBlue;Smoothness;26;0;Create;False;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;72;-2971.919,-1337.612;Inherit;True;Property;_DetailNormalMap;_Nml;10;1;[SingleLineTexture];Create;False;0;0;0;False;0;False;14;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;74;-2971.919,-1145.612;Inherit;True;Property;_CamoSpc;_Spc;12;1;[SingleLineTexture];Create;False;0;0;0;False;0;False;18;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;76;-2971.919,-953.6118;Inherit;True;Property;_CamoGls;_Gls;13;1;[SingleLineTexture];Create;False;0;0;0;False;0;False;19;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;175;-1318.727,-1607.421;Inherit;True;Property;_ColBlue;_Col;23;1;[SingleLineTexture];Create;False;2;________________________________________________________________________________________________;Red;0;0;False;0;False;1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;167;-1132.81,-1340.662;Inherit;True;Property;_NmlBlue;_Nml;24;1;[SingleLineTexture];Create;False;0;0;0;False;0;False;14;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;169;-1132.81,-956.6622;Inherit;True;Property;_GlsBlue;_Gls;27;1;[SingleLineTexture];Fetch;False;0;0;0;False;0;False;19;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;168;-1132.81,-1148.662;Inherit;True;Property;_SpcBlue;_Spc;26;1;[SingleLineTexture];Create;False;0;0;0;False;0;False;18;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=A067A0BFC8364B69651275D35D5843B4C94186D2