// Upgrade NOTE: upgraded instancing buffer 'HiddenTITANFALLTerrainTransparent' to new syntax.

// Made with Amplify Shader Editor v1.9.1.5
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "Hidden/TITANFALL/Terrain (Transparent)"
{
	Properties
	{
		...
		[Header(________________________________________________________________________________________________)][Header(Terrain Blending (Red))][SingleLineTexture]_DetailMask("_Msk", 2D) = "black" {}
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(HiddenTITANFALLTerrainTransparent)
			UNITY_DEFINE_INSTANCED_PROP(float4, _Tiling)
#define _Tiling_arr HiddenTITANFALLTerrainTransparent
			UNITY_DEFINE_INSTANCED_PROP(float4, _DetailTiling)
#define _DetailTiling_arr HiddenTITANFALLTerrainTransparent
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color)
#define _Color_arr HiddenTITANFALLTerrainTransparent
			UNITY_DEFINE_INSTANCED_PROP(float4, _EmissionColor)
#define _EmissionColor_arr HiddenTITANFALLTerrainTransparent
			UNITY_DEFINE_INSTANCED_PROP(int, _DepthOffset)
#define _DepthOffset_arr HiddenTITANFALLTerrainTransparent
			UNITY_DEFINE_INSTANCED_PROP(int, _CullMode)
#define _CullMode_arr HiddenTITANFALLTerrainTransparent
			UNITY_DEFINE_INSTANCED_PROP(float, _NormalScale)
#define _NormalScale_arr HiddenTITANFALLTerrainTransparent
			UNITY_DEFINE_INSTANCED_PROP(float, _DetailBumpStrength)
#define _DetailBumpStrength_arr HiddenTITANFALLTerrainTransparent
			UNITY_DEFINE_INSTANCED_PROP(float, _Glossiness)
#define _Glossiness_arr HiddenTITANFALLTerrainTransparent
		UNITY_INSTANCING_BUFFER_END(HiddenTITANFALLTerrainTransparent)
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			o.Occlusion = Ao32.r;
			float temp_output_126_0 = ( 1.0 - i.vertexColor.r );
			o.Alpha = temp_output_126_0;
			clip( temp_output_126_0 - _MaskClip );
		}
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-384,-16;Float;False;True;-1;2;T3_TFShaderGUI;0;0;StandardSpecular;Hidden/TITANFALL/Terrain (Transparent);False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;False;False;False;False;False;Back;0;False;;0;False;;True;0;True;_DepthOffset;0;False;_DepthOffset;False;0;Custom;0.5;True;True;0;True;Transparent;;AlphaTest;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;2;5;False;;10;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;_CullMode;-1;0;True;_MaskClip;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;60;-1851.894,1525.609;Inherit;False;CamoMask;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;125;-615.2439,581.3156;Inherit;False;InstancedProperty;_MaskClip;MaskClip;21;0;Create;True;0;0;0;False;0;False;0.2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;124;-475.7516,504.724;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;126;-281.635,565.3747;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=4D6EC77FB8FC23D12E352D8E9AB7AD9F25CDC8DA