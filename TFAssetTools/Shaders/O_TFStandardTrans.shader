...
#define _Glossiness_arr HiddenTITANFALLTransparentStandardOptimized
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float4 temp_cast_5 = (( GlsExp106 * _Glossiness_Instance * Ao32 )).xxxx;
			float4 DetailGloss77 = tex2D( _CamoGls, DetailUV117 );
			float4 lerpResult93 = lerp( temp_cast_5 , DetailGloss77 , CamoMask60);
...
ASEEND*/
//CHKSM=41F0372F7241B0B1848191F1BCBDAD457B9A9E2C